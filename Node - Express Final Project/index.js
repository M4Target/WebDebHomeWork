...
app.post("/submit", (req, res) => {
  ...
  let R_adj = Math.round(Math.random() * adj.length);
  let R_noun = Math.round(Math.random() * noun.length);

  let Adjustive = adj[R_adj];
  let Noun = noun[R_noun];

  res.render("index.ejs", { Adjustive: adj[R_adj], Noun: noun[R_noun] });
  //Then:
